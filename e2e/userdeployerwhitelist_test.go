...
func TestContractUserDeployerWhitelist(t *testing.T) {
	tests := []struct {
		name       string
		testFile   string
		...
		{"userdeployerwhitelist", "userdeployerwhitelist.toml", 1, 3, "userdeployerwhitelist.genesis.json",
			"userdeployerwhitelist-loom.yaml"},
	}
