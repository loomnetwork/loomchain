...
func TestEthJSONRPC2(t *testing.T) {
	tests := []struct {
		...
		{"blockNumber", "eth-1-test.toml", 4, 1, "empty-genesis.json", "eth-test-loom.yaml"},
		{"getBlockByNumber", "eth-3-test.toml", 4, 1, "empty-genesis.json", "eth-test-loom.yaml"},
		{"getBlockTransactionCountByNumber", "eth-4-test.toml", 4, 1, "empty-genesis.json", "eth-test-loom.yaml"},
		{"getLogs", "eth-5-test.toml", 4, 4, "empty-genesis.json", "eth-test-loom.yaml"},
