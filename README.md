...
```
./loom call -a pubkeyFile -k prikeyFile -i inputDataFile -c default:0xB448D7db27192d54FeBdA458B81e7383F8641c8A
...
You can use `static-call` similarly to `call` run a read only method.
