...
builtin: contracts/coin.so.1.0.0 contracts/dpos.so.1.0.0 contracts/dpos.so.2.0.0 contracts/dpos.so.3.0.0 contracts/plasmacash.so.1.0.0 contracts/chainconfig.so.1.0.0
...
contracts/chainconfig.so.1.0.0:
	go build -buildmode=plugin -o $@ $(PKG)/builtin/plugins/chainconfig/plugin
