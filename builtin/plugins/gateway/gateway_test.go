...
func (ts *GatewayTestSuite) TestLoomCoinTG() {
	...
	require.EqualError(gwHelper.LoomcoinContract.ProcessEventBatch(gwHelper.LoomcoinGWContractCtx(fakeCtx.WithSender(oracleAddr)), &ProcessEventBatchRequest{
	...
	require.Nil(gwHelper.LoomcoinContract.ProcessEventBatch(gwHelper.LoomcoinGWContractCtx(fakeCtx.WithSender(oracleAddr)), &ProcessEventBatchRequest{
