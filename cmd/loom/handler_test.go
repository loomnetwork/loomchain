...
func TestTxHandlerWithInvalidCaller(t *testing.T) {
	...
	router.HandleDeliverTx(1, loomchain.GeneratePassthroughRouteHandler(
		&vm.DeployTxHandler{Manager: vmManager, CreateRegistry: createRegistry},
	))
